...
module.exports = function (content) {
  var defaultLoaders = {
    ...
    css: 'style-loader?loadable=true!css-loader',
  ...
  if (
    ...
    defaultLoaders.css = 'style-loader?loadable=true!css-loader?sourceMap'
  }
  ...
  var output = 'var utils = require(' +
                 loaderUtils.stringifyRequest(this, '!' + path.join(__dirname, 'utils.js')) +
               ')\n' +
               'var __vue_script__, __vue_template__\n' +
               'var __vue_styles__ = {}, __vue_style_loaders__ = []\n'
  ...
  function setCssModule (style, require) {
    ...
    if (style.module) {
      if (style.module in cssModules) {
        ...
        concatString = '__vue_styles__["' + style.module + '"] = ' + require
      }
    }
    return '__vue_style_loaders__.push(' + concatString + ')\n'
  }
  ...
  if (!query.inject) {
    ...
    output +=
      ...
      '})\n' +
      // load style when component is attached to DOM and unload when destroyed
      '__vue_options__.attached = [].concat(__vue_options__.attached || [])\n' +
      '__vue_options__.attached.push(function () {\n' +
      '  var doc = utils.getDocument(this.$el)\n' +
      '  this.$nextTick(function () {' +
      '    __vue_style_loaders__.forEach(function (loader) {\n' +
      '      loader.load({doc: doc})\n' +
      '    })\n' +
      '  })' +
      // '  var unloads = []\n' +
      // '  __vue_style_loaders__.forEach(function (loader) {\n' +
      // '    unloads.push(loader.load({doc: doc}))\n' +
      // '  })\n' +
